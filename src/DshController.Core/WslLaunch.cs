...
namespace DshController.Core
{
    ...
    public static class WslLaunch
    {
        ...
        /// </summary>
        /// <param name="noOpen">R4：true 时给 dsh web 追加 --no-open（重启路径不拉浏览器，发行版内同样适用）。</param>
        public static string BuildLaunchScript(int port, string wslWorkspace, string dshCmd,
            IReadOnlyList<string> trustedHosts, string harnessVersion = "", string npxDir = "", bool noOpen = false)
        {
