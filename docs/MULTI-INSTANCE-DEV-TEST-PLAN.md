...
> ⚠️ **历史文档**（v0.3.0 多实例轮，2026-08-16 编制）：本文 P0/P1 与 [7]-[12] 自检组已全部落地，并历经重构 2.0 与 2026-09 整改轮演进。
> **当前测试账与开放票见 `docs/TEST-RESULTS.md`「一、现状账 / 二、开放票」**；本文仅供追溯当初设计取舍（实例档案前身、锁/端口/隔离决策）。
